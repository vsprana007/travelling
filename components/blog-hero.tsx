    ...
    <section className="relative h-80 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        ...
        <nav className="flex items-center justify-center gap-2 mb-6 text-sm">
          ...
          <span className="text-amber-400">Travel Blog</span>
        </nav>

        <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4 leading-tight">Travel Stories & Guides</h1>
        <p className="text-lg md:text-xl text-gray-100 max-w-2xl mx-auto leading-relaxed">
          Discover insider tips, destination guides, and inspiring travel stories from around the world
        </p>
      </div>
    </section>
  )
